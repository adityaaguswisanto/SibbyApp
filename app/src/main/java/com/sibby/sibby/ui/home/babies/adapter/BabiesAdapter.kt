package com.sibby.sibby.ui.home.babies.adapter
...
import com.sibby.sibby.databinding.BabiesItemBinding
...
class BabiesAdapter(
    ...
    inner class MyViewHolder(private val binding: BabiesItemBinding) :
        ...
        fun bind(babies: Babies) = with(binding) {
            ...
            txtDate.text = "Pengajuan Pada Tanggal ${formatDate(babies.created_at)}"
        }
    }
